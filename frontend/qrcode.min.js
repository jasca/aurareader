/**
 * QRCode.js minimal standalone library for offline QR code generation
 */
var QRCode;
(function () {
	...
	QRCode = function (typeNumber, errorCorrectLevel) {
		var _typeNumber = typeNumber || 4;
		var _errorCorrectLevel = errorCorrectLevel || QRErrorCorrectLevel.M;
		var _modules = null;

		return {
			generateDataUrl: function (text, size) {
				size = size || 200;
				var qr = new QRCodeModel(_typeNumber, _errorCorrectLevel);
				qr.addData(text);
				qr.make();
